...
FigPreamble='PuppetsToyExample';


%----data params----
DataParams=struct;
DataParams.NumberOfDatapoints=1e3;
DataParams.ResizeFac=0.5;
...
TolFac=5e-4;% Tolerance factor for fixed rank approximation
...
EvfdParams=v2struct(NumberOfEigenVals,ntVec);
